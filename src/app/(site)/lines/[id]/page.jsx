    ...
    return {
      title:
        line.Name === "Culture Line"
          ? "Gjirokaster tour & Blue Eye Shuttle tour – Culture Line tour | KMG Shuttles"
          : line.Name === "Sea Line"
          ? "Albanian Riviera Shuttle tour – Sea Line tour | KMG Shuttles"
          : line.Name === "Sun Line"
          ? "Blue Eye Shuttle tour – Sun Line tour | Tours From Saranda to Blue Eye by KMG"
      ...
      openGraph: {
        ...
        description:
          line.Name === "Culture Line"
            ...
            : line.Name === "Sea Line"
            ? "Take the Albanian Riviera Shuttle tour – Sea Line, visiting Porto Palermo, Himare, and Borsh from Saranda. Scenic beach experience guaranteed!"
            : line.Name === "Sun Line"
